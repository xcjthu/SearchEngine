...
<body>
  ...
  <div class="SearchBlock">
    ...
    <img class="IndexImage" src="img/background.PNG" alt="肖特搜索引擎" />
    <form id="form1" name="form1" method="get" action="servlet/ImageServer">
      ...
      <input type="submit" value="搜索" style="background-color: #007fff; text-align: center; width: 100px; height: 40px;font-size: 20px; color: white; border: none">
    </form>
